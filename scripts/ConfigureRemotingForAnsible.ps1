...
$PriorExecutionPolicy = Get-ExecutionPolicy
$NewExecutionPolicy = "Unrestricted"
If ((get-ExecutionPolicy) -ne $NewExecutionPolicy) {
   Set-ExecutionPolicy $NewExecutionPolicy -Force
   Write-HostLog "Set Execution Policy back to $NewExecutionPolicy will return it to $PriorExecutionPolicy at exit."
  Exit
}
...
If ((get-ExecutionPolicy) -ne $PriorExecutionPolicy) {
   Set-ExecutionPolicy $PriorExecutionPolicy -Force
   Write-HostLog "Set Execution Policy back to $PriorExecutionPolicy"
  Exit
}
